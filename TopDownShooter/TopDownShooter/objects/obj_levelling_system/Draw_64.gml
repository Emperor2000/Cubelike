draw_healthbar(300, 400, 1000, 500, (global.count_since_level/((global.xp_start_rate*(global.current_level/3) )*global.current_level *global.xp_incr_rate))*100, c_black, c_navy, c_aqua, 0, true, true);
